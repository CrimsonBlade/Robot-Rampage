...
namespace Robot_Rampage
{
    static class WeaponManager
    {
        ...
        static private float shotMinTimer = 0.1f;
        static float rocketMinTimer = 0.5f;
        ...
        #region Effects Managment Methods
        ...
        #region Weapons Managment Methods
        public static void FireWeapon(Vector2 location, Vector2 velocity)
        {
            switch (CurrentWeaponType)
            {
                ...
                case WeaponType.Triple:
                    ...
                    AddShot(location, new Vector2((float)Math.Cos(baseAngle - offset), (float)Math.Sin(baseAngle - offset)
                        ) * velocity.Length(), 0);
